...
// 1. agencyData.js (Roofer-specific metrics and data)
files['src/data/agencyData.js'] = `export const AGENCY_METRICS = [
  {
    id: 'contracts',
...
console.log('agencyData.js ready');
`;

// Write the script to create agencyData.js and we will populate the rest!
fs.writeFileSync('rebuild_for_roofers.mjs', files['src/data/agencyData.js'] ? `import fs from 'fs';\nfs.writeFileSync('src/data/agencyData.js', ${JSON.stringify(files['src/data/agencyData.js'])}, 'utf8');\nconsole.log('Updated agencyData.js');` : '', 'utf8');
